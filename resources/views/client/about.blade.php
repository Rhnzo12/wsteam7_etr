    ...
    <section class="container" style="padding: 60px 0;">
        ...
        <div class="team-grid"
            ...
            <div class="team-member-card"
                ...
                <img src="{{ asset('images/profile1.png') }}" alt="Team Member 1"
                    style="width: 150px; height: 150px; border-radius: 50%; object-fit: cover; margin-bottom: 15px; border: 3px solid #5b21b6;">
                <h3 style="font-size: 1.5em; color: #333; margin-bottom: 5px;">Zoren</h3>
                <p style="font-size: 1em; color: #777; margin-bottom: 10px;">Role: Admin Task</p>
                <p style="font-size: 1em; color: #00674F; font-weight: bold;">zoren@gmail.com</p>
            </div>

            {{-- Team Member 2 --}}
            <div class="team-member-card"
                style="background-color: #ffffff; padding: 25px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.05); text-align: center;">
                <img src="{{ asset('images/profile1.png') }}" alt="Team Member 2"
                    style="width: 150px; height: 150px; border-radius: 50%; object-fit: cover; margin-bottom: 15px; border: 3px solid #5b21b6;">
                ...
                <p style="font-size: 1em; color: #00674F; font-weight: bold;">Jayremy@gmail.com</p>
            </div>

            {{-- Team Member 3 --}}
            <div class="team-member-card"
                style="background-color: #ffffff; padding: 25px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.05); text-align: center;">
                <img src="{{ asset('images/profile2.png') }}" alt="Team Member 3"
                    style="width: 150px; height: 150px; border-radius: 50%; object-fit: cover; margin-bottom: 15px; border: 3px solid #5b21b6;">
                ...
                <p style="font-size: 1em; color: #00674F; font-weight: bold;">jelan@gmail.com</p>
            </div>

            {{-- Team Member 4 --}}
            <div class="team-member-card"
                style="background-color: #ffffff; padding: 25px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.05); text-align: center;">
                <img src="{{ asset('images/profile1.png') }}" alt="Team Member 4"
                    style="width: 150px; height: 150px; border-radius: 50%; object-fit: cover; margin-bottom: 15px; border: 3px solid #5b21b6;">
                <h3 style="font-size: 1.5em; color: #333; margin-bottom: 5px;">Gian</h3>
                <p style="font-size: 1em; color: #777; margin-bottom: 10px;">Role: User Feature</p>
                <p style="font-size: 1em; color: #00674F; font-weight: bold;">sgian@gmail.com</p>
            </div>
        </div>
    </section>
@endsection
