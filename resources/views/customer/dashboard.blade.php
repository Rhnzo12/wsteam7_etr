@extends('customer.layouts.apps') {{-- Ito ang nag-e-extend ng master layout --}}
<style>
    .category-img {
    width: 100%;
    height: 200px;
...
@section('content')
    {{-- Dito ilalagay ang content na papasok sa @yield('content') sa master layout --}}
     ...
     <section class="hero-section">
       <h1 style="font-style: italic;">WELCOME TO CRISPA {{ $user->name }}.</h1>
    ...
    {{-- Hero Section --}}
     <section class="hero-section">
       ...
       <h3 style="color:#9B7514;">THREAD OF THE FILIPINO.</h3>
        ...
        <a href="{{ route('customerProducts') }}" class="btn-more">Shop Now <span class="arrow">&rarr;</span></a>
    </section>
    ...
    {{-- Products Section Heading (New addition) --}}
     <section class="container">
            ...
            @forelse($products as $prod)
                <div class="product-card">
                    <h3>
                        ...
                        <a href="{{ route('customerProductDetail', $prod->id) }}">{{ $prod->title }}</a>
        ...
        <a href="{{ route('customerProducts') }}" class="btn-more">View All Products <span class="arrow">&rarr;</span></a>
    </section>
    ...
    <section class="container">
                ...
                <div class="category-card">
                    <h3>
                        <img class="category-img"  src="{{ asset($cat->image ?? 'images/default-product.png') }}" alt="{{ $cat->name }}">
                         ...
                         <a href="{{ route('customerProductDetail', $cat->id) }}">{{ $cat->name }}</a>
        ...
        <a href="{{ route('customerCategory') }}" class="btn-more">More Categories <span class="arrow">&rarr;</span></a>
    </section>
@endsection
