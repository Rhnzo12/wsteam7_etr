...
<body>
   <nav class="navbar">
        <ul>
            ...
            <li><a href="" class=""><i class="fa fa-users"></i>Users</a></li>
            <li><a href="" class=""><i class="fa fa-chart-bar"></i>Reports</a></li>
            <li><a href="" class=""><i class="fa fa-tags"></i>Discounts</a></li>
            <li><a href="" class="" style="color: red;"><i class="fa fa-sign-out-alt" style="color: red;"></i>Logout</a></li>
        </ul>
    </nav>
    <div class="content">
        @yield('content')
